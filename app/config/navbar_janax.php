...
return [
    ...
    'items' => [
        ...
        'news'  => [
            'text'  => 'News',
            'url'   => $this->di->get('url')->create('news'),
            'title' => ''
        ], 
        ...
        'game'  => [
            'text'  => 'Game',
            'url'   => $this->di->get('url')->create('free-racing-game'),
            'title' => ''
        ], 
        ...
        'about'  => [
            ...
            'submenu' => [
                ...
                'items' => [
                    ...
                    'documentation'  => [
                        'text'  => 'Documentation',
                        'url'   => $this->di->get('url')->create('documentation'),
                        'title' => ''
                        ],
                    ...
                    'how-to-use'  => [
                        'text'  => 'How To Use',
                        'url'   => $this->di->get('url')->create('how-to-use'),
                        'title' => ''
                        ],
                 ],
             ],
