    ...
    public function getValidationMessages()
    {
        ...
        if (isset($this['validation-messages'])) {
            ...
            foreach ($this['validation-messages'] as $val) {
                $message .= "<li class='warning'>{$val}</li>\n";
            }
    ...
    public function getHTMLDetails()
    {
        ...
        $label = isset($this['label'])
            ? ($this['label'] . (isset($this['required']) && $this['required']
                ...
                : null) . (isset($this['description']) && $this['description']
                ? " <i class='fa fa-info-circle cf-info'></i>"
                : null))
            : null;
...
EOD;
    ...
    public function validate($rules, $form = null)
    {
        ...
        $tests = [
            ...
            'not_equal' => [
                'message' => 'The value is not correct.',
            ...
            'email_adress' => [
                'message' => 'Must be an E-mail adress.',
                'test' => function ($value) {
            ...
            'web_adress' => [
                'message' => 'This field must be empty or contain an URL, beginning with http://, https:// eller ftp://',
                'test' => function ($value) {
            if (!empty($value)) {
            ...
            'min_char' => [
                'message' => 'You need to enter more characters.',
                'test' => 'return strlen($value) > $form[$arg] ;'
            ],
            
            'max_char' => [
                'message' => 'You need to enter fewer characters.',
                'test' => 'return strlen($value) < $form[$arg] ;'
            ],
